...
To add (and remove!) some stuff I like and "fix" some odd key bindings I really don't like :-)
...
Now you should create a new <tt>.vimrc</tt> file in your home directory that loads the pre-configured one that comes bundled in this package. You can do it on Linux/Mac using a symbolic link:
...
On Windows you should create a <tt>_vimrc</tt> (underline instead of dot) and a <tt>_gvimrc</tt> and add the following line inside:
